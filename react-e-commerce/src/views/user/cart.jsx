    ...
    return (
      <div className="container mt-5">
        <div className="row">
          <div className="row">
            <div
              className="col-lg-9 col-sm-12 bg-white p-3 cart-left-col"
              style={{ height: 591, overflowY: "auto" }}
            >
                    ...
                    <div className="product-details col-10 row">
                      <div className="col-5">
                        <p className="title m-0">
                          {"Samsung Galaxy A52 - 6.5 256GB/8GB Dual Sim Mobile Phone - Awesome White".slice(
                            0,
                            50
                          )}
                        </p>
            ...
            <div
              className="col-lg-3 col-sm-12 bg-white p-3 cart-right-col"
            ...
            >
              ...
              <div className="promo-code mt-4">
                ...
                <form action="">
                  <input
                    type="text"
                    className="input-style w-100 mt-0 bg-white"
                    placeholder="Enter your code"
                  />
                  <button type="submit" className="btn-style mt-3 mb-5 w-50">
                    Apply
                  </button>
                </form>
              </div>
              ...
              <div className="checkout">
                <div className="total-cost row">
                  ...
                  <button type="submit" className="btn-style mt-2">
                    Checkout
                  </button>
                </div>
              </div>
